...
client.application_uri = "urn:freeopcua:AutomateFriendly" # add uri of certificate
client.set_security_string("Basic256Sha256,SignAndEncrypt,PLC-certificate.der,PLC-certificate.pem") #Add PLC certificate
                        ...
                        if not filtered_existing_df.empty:
                           ...
                           # print(filtered_existing_df)
                            ...
                            if last_row_existing['Value'] == last_row_filtered['Value']:
                                print(f"No updates needed for {variable}")
